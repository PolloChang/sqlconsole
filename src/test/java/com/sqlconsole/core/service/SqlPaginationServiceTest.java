...
public class SqlPaginationServiceTest {
    ...
    public void testOraclePagination() {
        ...
        assertTrue(result.toUpperCase().contains("FETCH NEXT 10 ROWS ONLY") || result.toUpperCase().contains("FETCH FIRST 10 ROWS ONLY"), "Result: " + result);
    }
    ...
    public void testSqlServerPagination() {
        ...
        assertTrue(result.toUpperCase().contains("OFFSET 10 ROWS"), "Result: " + result);
        assertTrue(result.toUpperCase().contains("FETCH NEXT 5 ROWS ONLY") || result.toUpperCase().contains("FETCH FIRST 5 ROWS ONLY"), "Result: " + result);
    }
